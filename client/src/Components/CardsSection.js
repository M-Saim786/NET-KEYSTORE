...
function CardsSection({ setBuyCase }) {
  ...
  return (
    <>
      <section class="cards___section position-relative border-red" style={{ border: "1px solid red" }}>
        <div class="container">
          ...
          <div class="row p-xl-3 mt-lg-5 mt-4 justify-content-center d-lg-block d-none " style={{border:"1px solid red"}}>
            <div>
